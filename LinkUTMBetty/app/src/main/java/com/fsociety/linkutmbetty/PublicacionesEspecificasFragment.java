 ...
 * {@link PublicacionesEspecificasFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 */
public class PublicacionesEspecificasFragment extends Fragment  implements SwipeRefreshLayout.OnRefreshListener {
    ListView listaPub;
    public String dato;
    ...
    public PublicacionesEspecificasFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_publicaciones_especificas, container, false);
        //Referencia al listView que está en fragmentPublicacionesEspecíficas
